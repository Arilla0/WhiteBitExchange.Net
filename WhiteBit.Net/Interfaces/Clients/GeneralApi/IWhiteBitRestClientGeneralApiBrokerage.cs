...
{
    /// <summary>
    /// WhiteBit brokerage endpoints.
    /// </summary>
    public interface IWhiteBitRestClientGeneralApiBrokerage
    {
        /// <summary>
        ...
        Task<WebCallResult<WhiteBitBrokerageSubAccountCreateResult>> CreateSubAccountAsync(int? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<WhiteBitBrokerageEnableMarginResult>> EnableMarginForSubAccountAsync(string subAccountId, int? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<WhiteBitBrokerageEnableFuturesResult>> EnableFuturesForSubAccountAsync(string subAccountId, int? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<WhiteBitBrokerageEnableLeverageTokenResult>> EnableLeverageTokenForSubAccountAsync(string subAccountId, int? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<WhiteBitBrokerageApiKeyCreateResult>> CreateApiKeyForSubAccountAsync(string subAccountId, bool isSpotTradingEnabled,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Api key result</returns>
        Task<WebCallResult<WhiteBitBrokerageSubAccountApiKey>> GetSubAccountApiKeyAsync(string subAccountId, string? apiKey = null, int? page = null, int? size = null, int? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Api key result</returns>
        Task<WebCallResult<WhiteBitBrokerageSubAccountApiKey>> ChangeSubAccountApiKeyPermissionAsync(string subAccountId, string apiKey,
        ...
        Task<WebCallResult<WhiteBitBrokerageAddIpRestrictionResult>> AddIpRestrictionForSubAccountApiKeyAsync(string subAccountId,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Restriction result</returns>
        Task<WebCallResult<WhiteBitBrokerageIpRestriction>> ChangeIpRestrictionForSubAccountApiKeyAsync(string subAccountId,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Restriction result</returns>
        Task<WebCallResult<WhiteBitBrokerageIpRestriction>> GetIpRestrictionForSubAccountApiKeyAsync(string subAccountId,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Restriction result</returns>
        Task<WebCallResult<WhiteBitBrokerageIpRestrictionBase>> DeleteIpRestrictionForSubAccountApiKeyAsync(string subAccountId,
            string apiKey, string ipAddress, int? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<IEnumerable<WhiteBitBrokerageSubAccount>>> GetSubAccountsAsync(string? subAccountId = null, int? page = null, int? size = null, int? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<WhiteBitBrokerageSubAccountCommission>> ChangeSubAccountCommissionAsync(string subAccountId, decimal makerCommission, decimal takerCommission,
        ...
        Task<WebCallResult<WhiteBitBrokerageSubAccountFuturesCommission>> ChangeSubAccountFuturesCommissionAdjustmentAsync(string subAccountId, string symbol,
        ...
        Task<WebCallResult<IEnumerable<WhiteBitBrokerageSubAccountFuturesCommission>>> GetSubAccountFuturesCommissionAdjustmentAsync(string subAccountId,
        ...
        Task<WebCallResult<WhiteBitBrokerageSubAccountCoinFuturesCommission>> ChangeSubAccountCoinFuturesCommissionAdjustmentAsync(string subAccountId,
        ...
        Task<WebCallResult<IEnumerable<WhiteBitBrokerageSubAccountFuturesCommission>>> GetSubAccountCoinFuturesCommissionAdjustmentAsync(string subAccountId,
        ...
        Task<WebCallResult<WhiteBitBrokerageAccountInfo>> GetBrokerAccountInfoAsync(int? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<WhiteBitBrokerageTransferResult>> TransferUniversalAsync(string asset, decimal quantity,
        ...
        Task<WebCallResult<IEnumerable<WhiteBitBrokerageTransferTransactionUniversal>>> GetTransferHistoryUniversalAsync(
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Transfer result</returns>
        Task<WebCallResult<WhiteBitBrokerageTransferResult>> TransferAsync(string asset, decimal quantity,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Transfer result</returns>
        Task<WebCallResult<WhiteBitBrokerageTransferFuturesResult>> TransferFuturesAsync(string asset, decimal quantity, WhiteBitBrokerageFuturesType futuresType,
            string? fromId, string? toId, string? clientTransferId = null, int? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Transfer history</returns>
        Task<WebCallResult<IEnumerable<WhiteBitBrokerageTransferTransaction>>> GetTransferHistoryAsync(string? fromId = null, string? toId = null, string? clientTransferId = null,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Transfer history</returns>
        Task<WebCallResult<WhiteBitBrokerageTransferFuturesTransactions>> GetTransferFuturesHistoryAsync(string subAccountId,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<WhiteBitBrokerageSubAccountDepositTransaction>>> GetSubAccountDepositHistoryAsync(string? subAccountId = null,
            string? coin = null, WhiteBitBrokerageSubAccountDepositStatus? status = null, DateTime? startDate = null, DateTime? endDate = null,
        ...
        Task<WebCallResult<IEnumerable<WhiteBitBrokerageRebate>>> GetBrokerCommissionRebatesRecentAsync(string subAccountId,
        ...
        Task<WebCallResult<IEnumerable<WhiteBitBrokerageFuturesRebate>>> GetBrokerFuturesCommissionRebatesHistoryAsync(WhiteBitBrokerageFuturesType futuresType,
        ...
        Task<WebCallResult<WhiteBitBrokerageChangeBnbBurnSpotAndMarginResult>> ChangeBnbBurnForSubAccountSpotAndMarginAsync(string subAccountId, bool spotBnbBurn,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Result</returns>
        Task<WebCallResult<WhiteBitBrokerageChangeBnbBurnMarginInterestResult>> ChangeBnbBurnForSubAccountMarginInterestAsync(string subAccountId, bool interestBnbBurn,
            int? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<WhiteBitBrokerageBnbBurnStatus>> GetBnbBurnStatusForSubAccountAsync(string subAccountId, int? receiveWindow = null, CancellationToken ct = default);
        ...
        Task<WebCallResult<WhiteBitBrokerageSpotAssetInfo>> GetSubAccountSpotAssetInfoAsync(string? subAccountId = null,
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Asset info</returns>
        Task<WebCallResult<WhiteBitBrokerageMarginAssetInfo>> GetSubAccountMarginAssetInfoAsync(string? subAccountId = null,
            int? page = null, int? size = null, int? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns>Asset info</returns>
        Task<WebCallResult<WhiteBitBrokerageFuturesAssetInfo>> GetSubAccountFuturesAssetInfoAsync(WhiteBitBrokerageFuturesType futuresType,
