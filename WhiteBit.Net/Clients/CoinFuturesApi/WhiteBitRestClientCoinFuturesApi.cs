...
{
    /// <inheritdoc cref="IWhiteBitRestClientCoinFuturesApi" />
    public class WhiteBitRestClientCoinFuturesApi : RestApiClient, IWhiteBitRestClientCoinFuturesApi, IFuturesClient
    {
        #region fields 
        /// <inheritdoc />
        ...
        internal WhiteBitFuturesCoinExchangeInfo? _exchangeInfo;
        ...
        internal WhiteBitRestClientCoinFuturesApi(ILogger logger, HttpClient? httpClient, WhiteBitRestOptions options)
            : base(logger, httpClient, options.Environment.CoinFuturesRestAddress!, options, options.CoinFuturesOptions)
        {
            Account = new WhiteBitRestClientCoinFuturesApiAccount(this);
            ExchangeData = new WhiteBitRestClientCoinFuturesApiExchangeData(logger, this);
            Trading = new WhiteBitRestClientCoinFuturesApiTrading(logger, this);
