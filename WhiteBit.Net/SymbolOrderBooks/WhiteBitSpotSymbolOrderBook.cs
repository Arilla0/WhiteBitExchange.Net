...
namespace WhiteBit.Net.SymbolOrderBooks
{
    ...
    /// </summary>
    public class WhiteBitSpotSymbolOrderBook : SymbolOrderBook
    {
        ...
        public WhiteBitSpotSymbolOrderBook(string symbol, Action<WhiteBitOrderBookOptions>? optionsDelegate = null)
        ...
        public WhiteBitSpotSymbolOrderBook(
            string symbol,
            Action<WhiteBitOrderBookOptions>? optionsDelegate,
            ILogger<WhiteBitSpotSymbolOrderBook>? logger,
            IWhiteBitRestClient? restClient,
            IWhiteBitSocketClient? socketClient) : base(logger, "WhiteBit", symbol)
        {
        ...
        private void HandleUpdate(DataEvent<IWhiteBitEventOrderBook> data)
        {
        ...
        private void HandleUpdate(DataEvent<IWhiteBitOrderBook> data)
        {
            if (Levels == null)            
                UpdateOrderBook(data.Data.LastUpdateId, data.Data.Bids, data.Data.Asks);            
            else            
