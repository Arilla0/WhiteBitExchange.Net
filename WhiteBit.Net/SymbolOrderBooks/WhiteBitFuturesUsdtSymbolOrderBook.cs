...
namespace WhiteBit.Net.SymbolOrderBooks
{
    ...
    /// </summary>
    public class WhiteBitFuturesUsdtSymbolOrderBook : SymbolOrderBook
    {
        ...
        public WhiteBitFuturesUsdtSymbolOrderBook(string symbol, Action<WhiteBitOrderBookOptions>? optionsDelegate = null)
        ...
        public WhiteBitFuturesUsdtSymbolOrderBook(
            string symbol,
            Action<WhiteBitOrderBookOptions>? optionsDelegate,
            ILogger<WhiteBitFuturesUsdtSymbolOrderBook>? logger,
        ...
        private void HandleUpdate(DataEvent<IWhiteBitFuturesEventOrderBook> data)
        {
            if (_limit == null)
            {
