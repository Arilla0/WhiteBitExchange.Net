...
namespace WhiteBit.Net.Objects.Models.Futures.Socket
{
    ...
    /// </summary>
    public class WhiteBitFuturesStreamLiquidationData : WhiteBitStreamEvent
    {
        /// <summary>
        /// The data of the event
        /// </summary>
        [JsonProperty("o")]
        public WhiteBitFuturesStreamLiquidation Data { get; set; } = default!;
    }

    /// <summary>
    /// 
    /// </summary>
    public class WhiteBitFuturesStreamLiquidation : IWhiteBitFuturesLiquidation
    {
        /// <summary>
        /// Symbol
        /// </summary>
