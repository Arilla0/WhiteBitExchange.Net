...
namespace WhiteBit.Net.Objects.Models.Futures.Socket
{
    ...
    /// </summary>
    public class WhiteBitFuturesStreamSymbolUpdate : WhiteBitStreamEvent
    {
        /// <summary>
        /// Symbol
        /// </summary>
        ...
        /// </summary>
        [JsonProperty("bks")]
        public IEnumerable<WhiteBitBracketUpdate>? Brackets { get; set; }
    }

    /// <summary>
    /// Bracket update
    /// </summary>
    public class WhiteBitBracketUpdate
    {
        /// <summary>
        /// Notional bracket
        /// </summary>
