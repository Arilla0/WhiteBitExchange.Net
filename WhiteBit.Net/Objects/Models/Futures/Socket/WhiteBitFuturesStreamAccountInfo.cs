...
namespace WhiteBit.Net.Objects.Models.Futures.Socket
{
    ...
    /// Account update
    /// </summary>
    public class WhiteBitFuturesStreamAccountUpdate: WhiteBitStreamEvent
    {
        /// <summary>
        /// The update data
        /// </summary>
        [JsonProperty("a")]
        public WhiteBitFuturesStreamAccountUpdateData UpdateData { get; set; } = new WhiteBitFuturesStreamAccountUpdateData();
        /// <summary>
        /// Transaction time
        /// </summary>
    ...
    /// Account update data
    /// </summary>
    public class WhiteBitFuturesStreamAccountUpdateData
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("B")]
        public IEnumerable<WhiteBitFuturesStreamBalance> Balances { get; set; } = Array.Empty<WhiteBitFuturesStreamBalance>();

        /// <summary>
        /// Positions
        /// </summary>
        [JsonProperty("P")]
        public IEnumerable<WhiteBitFuturesStreamPosition> Positions { get; set; } = Array.Empty<WhiteBitFuturesStreamPosition>();
    }

    /// <summary>
    /// Information about an asset balance
    /// </summary>
    public class WhiteBitFuturesStreamBalance
    {
        /// <summary>
    ...
    /// </summary>
    public class WhiteBitFuturesStreamPosition
    {
        /// <summary>
