...
namespace WhiteBit.Net.Objects.Models.Futures.Socket
{
    ...
    /// Order update
    /// </summary>
    public class WhiteBitFuturesStreamOrderUpdate: WhiteBitStreamEvent
    {
        /// <summary>
        /// Update data
        /// </summary>
        [JsonProperty("o")]
        public WhiteBitFuturesStreamOrderUpdateData UpdateData { get; set; } = new WhiteBitFuturesStreamOrderUpdateData();
    ...
    /// </summary>
    public class WhiteBitFuturesStreamOrderUpdateData
    {
        /// <summary>
        ...
        /// <summary>
        /// The id of the order as assigned by WhiteBit
        /// </summary>
        [JsonProperty("i")]
