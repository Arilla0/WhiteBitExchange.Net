...
namespace WhiteBit.Net.Objects.Models.Futures.Socket
{
    ...
    /// Margin update
    /// </summary>
    public class WhiteBitFuturesStreamMarginUpdate : WhiteBitStreamEvent
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("p")]
        public IEnumerable<WhiteBitFuturesStreamMarginPosition> Positions { get; set; } = Array.Empty<WhiteBitFuturesStreamMarginPosition>();
    ...
    /// </summary>
    public class WhiteBitFuturesStreamMarginPosition
    {
        /// <summary>
        /// Symbol
        /// </summary>
