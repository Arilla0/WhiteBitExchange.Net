...
namespace WhiteBit.Net.Objects.Models.Spot.Mining
{
    ...
    /// Revenue list
    /// </summary>
    public class WhiteBitRevenueList
    {
        /// <summary>
        ...
        /// Revenue items
        /// </summary>
        public IEnumerable<WhiteBitRevenueItem> AccountProfits { get; set; } = Array.Empty<WhiteBitRevenueItem>();
    }

    /// <summary>
    /// Revenue
    /// </summary>
    public class WhiteBitRevenueItem
    {
        /// <summary>
        /// Timestamp
        /// </summary>
