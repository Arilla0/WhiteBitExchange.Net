...
namespace WhiteBit.Net.Objects.Models.Spot.Mining
{
    ...
    /// Revenue list
    /// </summary>
    public class WhiteBitOtherRevenueList
    {
        /// <summary>
        ...
        /// Revenue items
        /// </summary>
        public IEnumerable<WhiteBitOtherRevenueItem> OtherProfits { get; set; } = Array.Empty<WhiteBitOtherRevenueItem>();
    }

    /// <summary>
    /// Revenue
    /// </summary>
    public class WhiteBitOtherRevenueItem
    {
        /// <summary>
        /// Timestamp
        /// </summary>
