...
namespace WhiteBit.Net.Objects.Models.Spot.Lending
{
    ...
    /// Lending account
    /// </summary>
    public class WhiteBitLendingAccount
    {
        /// <summary>
        ...
        public IEnumerable<WhiteBitLendingPositionAmount> PositionAmounts { get; set; } = Array.Empty<WhiteBitLendingPositionAmount>();
    }

    /// <summary>
    /// Lending position amount
    /// </summary>
    public class WhiteBitLendingPositionAmount
    {
        /// <summary>
        /// Amount of the asset
        /// </summary>
