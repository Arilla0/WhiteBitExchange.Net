...
namespace WhiteBit.Net.Objects.Models.Spot.Futures
{
    ...
    /// </summary>
    public class WhiteBitCrossCollateralWallet
    {
        /// <summary>
        ...
        /// Cross collaterals
        /// </summary>
        public IEnumerable<WhiteBitCrossCollateralWalletEntry> CrossCollaterals { get; set; } = Array.Empty<WhiteBitCrossCollateralWalletEntry>();
    }

    /// <summary>
    /// Cross collateral data
    /// </summary>
    public class WhiteBitCrossCollateralWalletEntry
    {
        /// <summary>
        /// Loan asset
        /// </summary>
