...
namespace WhiteBit.Net.Objects.Models.Spot.Socket
{
    ...
    /// MiniTick info
    /// </summary>
    public abstract class WhiteBitStreamMiniTickBase : WhiteBitStreamEvent, IWhiteBitMiniTick
    {
        /// <summary>
    ...
    /// Stream mini tick
    /// </summary>
    public class WhiteBitStreamMiniTick: WhiteBitStreamMiniTickBase
    {
        /// <inheritdoc/>
        [JsonProperty("v")]
    ...
    /// Stream mini tick
    /// </summary>
    public class WhiteBitStreamCoinMiniTick : WhiteBitStreamMiniTickBase
    {
        /// <inheritdoc/>
        [JsonProperty("q")]
        public override decimal Volume { get; set; }
