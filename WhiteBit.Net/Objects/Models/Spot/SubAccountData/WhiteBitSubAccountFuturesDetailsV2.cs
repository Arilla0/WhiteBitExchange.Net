...
namespace WhiteBit.Net.Objects.Models.Spot.SubAccountData
{
    ...
    /// </summary>
    public class WhiteBitSubAccountFuturesDetailsV2
    {
        /// <summary>
        /// Futures account response (USDT margined)
        /// </summary>
        [JsonProperty("futureAccountResp")]
        public WhiteBitSubAccountFuturesDetailV2Usdt UsdtMarginedFutures { get; set; } = default!;

        /// <summary>
        /// Delivery account response (COIN margined)
        /// </summary>
        [JsonProperty("deliveryAccountResp")]
        public WhiteBitSubAccountFuturesDetailV2 CoinMarginedFutures { get; set; } = default!;
    }

    /// <summary>
    /// Sub account futures details
    /// </summary>
    public class WhiteBitSubAccountFuturesDetailV2
    {
        /// <summary>
        ...
        /// </summary>
        public IEnumerable<WhiteBitSubAccountFuturesAsset> Assets { get; set; } = Array.Empty<WhiteBitSubAccountFuturesAsset>();
        /// <summary>
        /// Can deposit
        /// </summary>
    ...
    /// Sub account futures details
    /// </summary>
    public class WhiteBitSubAccountFuturesDetailV2Usdt : WhiteBitSubAccountFuturesDetailV2
    {
        /// <summary>
