...
namespace WhiteBit.Net.Objects.Models.Spot
{
    ...
    public class WhiteBitSymbolFilter
    {
        /// <summary>
    ...
    /// Price filter
    /// </summary>
    public class WhiteBitSymbolPriceFilter: WhiteBitSymbolFilter
    {
        /// <summary>
    ...
    /// </summary>
    public class WhiteBitSymbolPercentPriceFilter : WhiteBitSymbolFilter
    {
        /// <summary>
    ...
    /// Price percentage filter
    /// </summary>
    public class WhiteBitSymbolPercentPriceBySideFilter : WhiteBitSymbolFilter
    {
        /// <summary>
    ...
    /// Lot size filter
    /// </summary>
    public class WhiteBitSymbolLotSizeFilter : WhiteBitSymbolFilter
    {
        /// <summary>
    ...
    /// </summary>
    public class WhiteBitSymbolMarketLotSizeFilter : WhiteBitSymbolFilter
    {
        /// <summary>
        /// The minimal quantity of an order
        /// </summary>
    ...
    /// Min notional filter
    /// </summary>
    public class WhiteBitSymbolMinNotionalFilter : WhiteBitSymbolFilter
    {
        /// <summary>
    ...
    /// Notional filter
    /// </summary>
    public class WhiteBitSymbolNotionalFilter : WhiteBitSymbolFilter
    {
        /// <summary>
        /// The minimal total quote quantity of an order. This is calculated by Price * Quantity.
        /// </summary>
    ...
    ///Max orders filter
    /// </summary>
    public class WhiteBitSymbolMaxOrdersFilter : WhiteBitSymbolFilter
    {
        /// <summary>
    ...
    /// </summary>
    public class WhiteBitSymbolMaxAlgorithmicOrdersFilter : WhiteBitSymbolFilter
    {
        /// <summary>
    ...
    /// </summary>
    public class WhiteBitSymbolIcebergPartsFilter : WhiteBitSymbolFilter
    {
        /// <summary>
    ...
    /// Max position filter
    /// </summary>
    public class WhiteBitSymbolMaxPositionFilter : WhiteBitSymbolFilter
    {
        /// <summary>
    ...
    /// </summary>
    public class WhiteBitSymbolTrailingDeltaFilter : WhiteBitSymbolFilter
    {
        /// <summary>
    ...
    /// </summary>
    public class WhiteBitMaxNumberOfIcebergOrdersFilter : WhiteBitSymbolFilter
    {
        /// <summary>
