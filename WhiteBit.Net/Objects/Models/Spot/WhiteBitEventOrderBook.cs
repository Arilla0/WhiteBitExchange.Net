...
namespace WhiteBit.Net.Objects.Models.Spot
{
    ...
    /// Stream order book
    /// </summary>
    public class WhiteBitEventOrderBook: WhiteBitOrderBook, IWhiteBitEventOrderBook
    {
        /// <summary>
        /// The id of this update, can be synced with WhiteBitClient.Spot.GetOrderBook to update the order book
        /// </summary>
        [JsonProperty("U")]
        ...
        /// </summary>
        [JsonProperty("b")]
        internal IEnumerable<WhiteBitOrderBookEntry> BidsStream { set => Bids = value; }

        /// <summary>
        /// Setter for asks (needed forJson.Net)
        /// </summary>
        [JsonProperty("a")]
        internal IEnumerable<WhiteBitOrderBookEntry> AsksStream { set => Asks = value; }
    }
}
