...
namespace WhiteBit.Net.Objects.Models.Spot
{
    ...
    /// </summary>
    public class WhiteBitElligableDusts
    {
        /// <summary>
        /// Total BTC value
        /// </summary>
        ...
        /// Assets
        /// </summary>
        public IEnumerable<WhiteBitElligableDust> Details { get; set; } = Array.Empty<WhiteBitElligableDust>();
    }

    /// <summary>
    /// Asset which can be converted
    /// </summary>
    public class WhiteBitElligableDust
    {
        /// <summary>
        /// Asset
        /// </summary>
