...
namespace WhiteBit.Net.Objects.Models.Spot
{
    ...
    /// Recent trade info
    /// </summary>
    public abstract class WhiteBitRecentTrade: IWhiteBitRecentTrade
    {
        /// <summary>
        /// The id of the trade
        /// </summary>
    ...
    /// </summary>
    public class WhiteBitRecentTradeQuote : WhiteBitRecentTrade
    {
        /// <inheritdoc />
    ...
    /// </summary>
    public class WhiteBitRecentTradeBase : WhiteBitRecentTrade
    {
        /// <inheritdoc />
        [JsonProperty("qty")]
        public override decimal QuoteQuantity { get; set; }
