...
namespace WhiteBit.Net.Objects.Models.Spot.Margin
{
    ...
    /// </summary>
    public class WhiteBitMarginDustAsset
    {
        /// <summary>
        /// Total btc
        /// </summary>
        ...
        /// Details
        /// </summary>
        public IEnumerable<WhiteBitMarginDustAssetDetails> Details { get; set; } = Array.Empty<WhiteBitMarginDustAssetDetails>();
    }

    /// <summary>
    /// Asset dust details
    /// </summary>
    public class WhiteBitMarginDustAssetDetails
    {
        /// <summary>
        /// Asset
        /// </summary>
